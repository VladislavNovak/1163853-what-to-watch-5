...
const Main = ({resetVisibleFilmsCount, activeGenre, promo, onPlayButtonClickHandler, visibleFilmsCount, onMoreButtonClickHandler, filteredFilms}) => {
  const {backgroundImage, title, poster, genre, released, id} = promo;
  resetVisibleFilmsCount(activeGenre);
